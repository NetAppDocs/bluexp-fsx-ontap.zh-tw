...
.開始之前
在建立新的 Volume 之前、您需要使用中的 https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-creating-connectors-aws.html["AWS的連接器"^]。
...
.. 您也可以選擇建立標記、按一下加號並輸入標記名稱和值、將磁碟區分類。
