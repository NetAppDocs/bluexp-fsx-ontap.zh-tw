...
您可以使用BlueXP在儲存環境之間複寫資料。若要設定FSXfor ONTAP Sfor Sfor S供 複寫、請參閱 https://docs.netapp.com/us-en/bluexp-replication/task-replicating-data.html["在系統之間複寫資料"^]。

您可以使用 BlueXP 複本與同步建立同步關係。若要設定同步關係、請參閱 https://docs.netapp.com/us-en/bluexp-copy-sync/task-creating-relationships.html["建立同步關係"^]。
