...
如需有關BlueXP或BlueXP微服務的一般問題、您可以從線上BlueXP聊天開始。

如需特定於BlueXP或內部微服務的技術支援問題、您可以使用您的BlueXP帳戶層級序號來開啟NetApp支援服務單。您需要 link:https://docs.netapp.com/us-en/cloud-manager-fsx-ontap/support/task-support-registration.html["註冊您的BlueXP帳戶"^] 以啟動支援。
